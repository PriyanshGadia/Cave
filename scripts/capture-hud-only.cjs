...
async function run() {
  ...
  fs.writeFileSync(path.join(ART, 'audit_ls1_verified_rule4_hud.png'), buf);
  console.log('Saved audit_ls1_verified_rule4_hud.png successfully!');
