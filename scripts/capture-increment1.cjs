// scripts/capture-increment1.cjs
...
async function run() {
  console.log('=== [LS2 INCREMENT 1 CAPTURE SUITE V3] ===\n');
  ...
  // ── CAPTURE 1: Wide Environmental Shot (before focusing) ──
  ...
  // ── CAPTURE 2: Focused Shot (Increment 1 Details) ──
  console.log('3. Capturing Increment 1 focused shot (focusSector("LS2"))...');
  await page.evaluate(() => {
  ...
  // ── CAPTURE 3: Rule 4 Diagnostic HUD ──
  console.log('4. Capturing Rule 4 HUD diagnostic pass...');
  ...
  await save('audit_ls2_increment1_rule4.png', await page.screenshot({ animations: 'disabled' }));
